...
const navItems = [
  ...
  { label: 'هدف‌ها', path: '/goals' },
  { label: 'تکراری‌ها', path: '/recurring' },
  { label: 'برنامه‌ریزی', path: '/planning' },
  { label: 'بدهی‌ها', path: '/debts' },
  { label: 'قوانین', path: '/rules' },
  { label: 'درآمد', path: '/income-planning' },
  { label: 'سلامت مالی', path: '/health' },

...
⁧پوستهٔ اندروید از نسخهٔ ۲، برنامه را از `https://date-one-roan.vercel.app` اجرا می‌کند. یک‌بار APK جدید را با همان امضای قبلی روی نسخهٔ موجود نصب کنید؛ اپ را حذف نکنید. داده‌های مالی و نسخه‌های محلی حساب‌ها پیش از شروع اپ منتقل می‌شوند، اطلاعات ورود قدیمی منتقل نمی‌شوند و همگام‌سازی ابری نیازمند انتخاب مجدد کاربر است. اولین اجرا اینترنت می‌خواهد؛ پس از تکمیل کش، رابط و داده‌های محلی آفلاین کار می‌کنند. نشست حساب همچنان در کوکی HttpOnly اندروید است.

⁧برای تغییرات بعدی وب، `build:vercel` و انتشار کامل سایت کافی است. در تنظیمات، «بررسی به‌روزرسانی» و سپس «اعمال به‌روزرسانی» را بزنید. «نمایش تست آپدیت» فقط پیام نمونه نشان می‌دهد و نصب واقعی نیست. تغییر کد نیتیو، مجوزها، دامنه یا پل اندروید همچنان APK جدید لازم دارد. جزئیات و آزمون‌ها در [راهنمای آپدیت](docs/in-app-updates.md) آمده است.
